...
/////////////// Write the MCQ below in the exactly same described format ///////////////
  ...
  const myQuestions = [
    {
      question: "The value of Numerical aperture of the single mode step index optical fiber is nearly:",  ///// Write the question inside double quotes
      answers: {
        a: "0.2",                  ///// Write the option 1 inside double quotes
        b: "2.0",                  ///// Write the option 2 inside double quotes
        c: "20",                  ///// Write the option 3 inside double quotes
